...
import 'package:penge_send/screens/comfirm_pin_page.dart';
...
class SetUpInScreen extends StatefulWidget {
  const SetUpInScreen({super.key});

  @override
  State<SetUpInScreen> createState() => _SetUpInScreenState();
}

class _SetUpInScreenState extends State<SetUpInScreen> {
  ...
  void onCLick(String set) async {
    await myPassSecStore.passcodeSetUp(passValue: set);
  }
    ...
    if (pinIndex == 4) {
      ...
      if (pinIndex == 4) {
        ...
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => const ComfirmPinPageScreen()));
      }
    }
  }
